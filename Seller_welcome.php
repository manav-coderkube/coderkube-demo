...
if (!isset($_SESSION['user_id']) || $_SESSION['user_type'] != 2) { // Assuming user_type 0 is admin
...
$sql = "SELECT user_id, user_name, user_email, user_phone, user_gender, user_type 
        FROM tbl_user WHERE user_type = $type"; // Removed WHERE clause to fetch all users
