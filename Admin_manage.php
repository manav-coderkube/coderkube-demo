    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editUserForm">
                ...
                <input type="text" name="user_name" id="edit_user_name"><br>

                <label for="edit_user_email">Email:</label>
                <input type="text" name="user_email" id="edit_user_email"><br>

                <label for="edit_user_phone">Phone:</label>
                <input type="text" name="user_phone" id="edit_user_phone"><br>

                <label for="edit_user_gender">Gender:</label>
                <select name="user_gender" id="edit_user_gender">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#editUserForm').submit(function (e) {
                ...
                const userPhone = $('#edit_user_phone').val().trim();
                const userGender = $('#edit_user_gender').val();
                const userType = $('#edit_user_type').val();

                // Validate Name (not empty)
                if (userName === "") {
                    $('#edit_user_name').after('<span class="error-message" style="color: red;">Name is required.</span>');
                    isValid = false;
                }
                ...
                if (userEmail === "") {
                    $('#edit_user_email').after('<span class="error-message" style="color: red;">Email is required.</span>');
                    isValid = false;
                } else if (!emailRegex.test(userEmail)) {
                    $('#edit_user_email').after('<span class="error-message" style="color: red;">Please enter a valid email address.</span>');
                    isValid = false;
                }
                ...
                if (userPhone === "") {
                    $('#edit_user_phone').after('<span class="error-message" style="color: red;">Phone number is required.</span>');
                    isValid = false;
                } else if (!phoneRegex.test(userPhone)) {
                    $('#edit_user_phone').after('<span class="error-message" style="color: red;">Please enter a valid phone number (10 digits).</span>');
                    isValid = false;
                }

                // Validate Gender (selected)
                if (userGender === "") {
                    $('#edit_user_gender').after('<span class="error-message" style="color: red;">Gender is required.</span>');
                    isValid = false;
                }

                // Validate User Type (selected)
                if (userType === "") {
                    $('#edit_user_type').after('<span class="error-message" style="color: red;">User type is required.</span>');
                    isValid = false;
                }
